...
import { MockApiService } from '@fuse/lib/mock-api';
import {
    chats as chatsData,
...
export class ChatMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Chats - GET
        // -----------------------------------------------------------------------------------------------------
        this._MockApiService.onGet('api/apps/chat/chats').reply(() => {
            // Clone the chats
        ...
        // @ Contacts - GET
        // -----------------------------------------------------------------------------------------------------
        this._MockApiService.onGet('api/apps/chat/contacts').reply(() => {
            // Clone the contacts
        ...
        // @ Profile - GET
        // -----------------------------------------------------------------------------------------------------
        this._MockApiService.onGet('api/apps/chat/profile').reply(() => {
            // Clone the profile
